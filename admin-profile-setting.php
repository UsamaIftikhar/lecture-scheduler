                            ...
                            <div class="card-body">
                                ...
                                <form class="needs-validation" novalidate action="admin-profile-setting.php" method="POST">
                                    ...
                                    <div class="position-relative row form-group"><label for="examplePassword" class="col-sm-2 col-form-label">Email</label>
                                        <div class="col-sm-10"><input name="email" id="email" placeholder="password placeholder" disabled value="<?PHP echo $userData['email'] ?>" type="text" class="form-control"></div>
                                    </div>
