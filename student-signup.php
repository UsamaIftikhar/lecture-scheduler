...
try {
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO user(fname,lname,email,password,type,rollno,department,phoneno) VALUES(:fname,:lname,:email,:password,:type,:rollno,:department,:phoneno)";
        ...
        if ($result) {
?>
            <div class="alert alert-success fade show" role="alert">Student Created Successfully. <a href="/lecture-scheduler/sign-in.php">Login Now</a></div>
        <?PHP
        } else {
        ?>
    ...
    <?PHP
    } elseif (strpos($e, $rollnoCheck) !== false) {
    ?>
        <div class="alert alert-danger fade show" role="alert">Rollno already used. Kindly try another.</div>
    <?PHP
    } else {
    ?>
        <div class="alert alert-danger fade show" role="alert">There were an error while submitting the form. Kindly try again</div>
...
<head>
    ...
    <title>Lecture Scheduler Student - Signup</title>
...
<body>
    <header class="header-section clearfix">
        ...
        <ul class="main-menu">
            ...
            <li><a style="color: #fc0255;" href="http://localhost:8888/lecture-scheduler/student-signup.php">Student Signup</a></li>
                        ...
                        <div class="card" style="border-radius: 15px; margin-top: 10px; margin-bottom: 150px;">
                            <div class="card-body p-5 ">
                                ...
                                <form class="needs-validation" novalidate action="student-signup.php" method="POST">
                                    ...
                                    <div class="mb-3">
                                        <label for="validationTooltip02">Roll No</label>
                                        <input type="text" class="form-control" name="rollno" placeholder="Roll No" required autocomplete="nope" />
                                    </div>
                                    <div class="mb-3">
