            ...
            <div class="app-header-left">
                ...
                <ul class="header-menu nav pl-2">
                    ...
                    <li class="dropdown nav-item">
                        <a href="./student-profile-setting.php" class="nav-link">
                            ...
                            <div class="widget-content-left">
                                <div class="btn-group">
                                    ...
                                    <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                        <div class="dropdown-item"><a href="./student-dashboard.php">User Account</a></div>
                                        <div class="dropdown-item"><a href="./student-profile-setting.php">Settings</a></div>
